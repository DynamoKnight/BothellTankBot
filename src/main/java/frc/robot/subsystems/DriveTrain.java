...
public class DriveTrain extends SubsystemBase {
  ...
  CANSparkMax frontRightMotor = new CANSparkMax(10, MotorType.kBrushless);
  CANSparkMax frontLeftMotor = new CANSparkMax(12, MotorType.kBrushless);
  CANSparkMax backRightMotor = new CANSparkMax(11, MotorType.kBrushless);
  CANSparkMax backLeftMotor = new CANSparkMax(1, MotorType.kBrushless);
